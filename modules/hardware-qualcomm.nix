...
in
{
  options.mobile = {
    ...
    hardware.socs.qualcomm.sm7250.enable = mkOption {
      type = types.bool;
      default = false;
      description = lib.mdDoc "enable when SOC is sm7250";
    };
  };
  ...
  config = mkMerge [
    ...
    {
      mobile = mkIf cfg.qualcomm-sm7250.enable {
        system.system = "aarch64-linux";
        quirks.fb-refresher.enable = true;
      };
    }
